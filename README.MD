...
| `description-to-nl.py`   | Converts image descriptions to natural language for use in image classification models.       | [View Documentation](docs/description-to-tags.md) |
